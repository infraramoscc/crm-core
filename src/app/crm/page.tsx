...
import { getPipelineOpportunities, moveOpportunityStage } from "@/app/actions/crm/crm-actions";
    ...
    return (
        <div className="flex flex-col gap-6 h-full min-h-[calc(100vh-8rem)]">
            ...
            <div className="flex gap-4 overflow-x-auto pb-4 h-full flex-1">
                {STAGES.map((stage) => {
                    const columnOpps = opportunities.filter(opp => opp.stage === stage.value);
                    ...
                    return (
                        ...
                        >
                            ...
                            <div className="flex flex-col gap-3 flex-1 overflow-y-auto pr-1">
                                {loading && columnOpps.length === 0 && <p className="text-xs text-muted-foreground p-2">Cargando...</p>}
                                {columnOpps.map(opp => {
